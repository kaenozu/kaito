...
STRINGS: dict[str, dict[str, str]] = {
    "ja": {
        ...
        "settings.preview": "プレビュー上限:",
        "settings.preview_max_size": "最大サイズ (MB):",
        "settings.preview_max_pixels": "最大画素数 (万画素):",
        "settings.save": "保存",
        ...
        "msg.load_canceled": "アーカイブの読み込みをキャンセルしました",
        "msg.preview_too_large": "ファイルが大きすぎてプレビューできません ({size})",
    ...
    "en": {
        ...
        "settings.preview": "Preview limits:",
        "settings.preview_max_size": "Max size (MB):",
        "settings.preview_max_pixels": "Max pixels (10k):",
        "settings.save": "Save",
        ...
        "msg.load_canceled": "Archive loading canceled",
        "msg.preview_too_large": "File too large to preview ({size})",
